...
const Header = () => {
    ...
    const menuItems = <>
        ...
        <li>{user ? <button className="btn btn-ghost" onClick={handleSignOut}>Sign-out</button>
    ...
    return (
        <div className="navbar bg-gradient-to-t from-cyan-500 to-blue-900 ... text-white">
            ...
            <label tabindex="1" for="dashboard-sidebar" className="btn btn-ghost navbar-end lg:hidden">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h8m-8 6h16" /></svg>
            </label>

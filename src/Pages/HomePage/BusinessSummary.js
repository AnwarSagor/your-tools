        ...
        <div className='lg:mx-12 my-6'>
            ...
            <div class="card bg-base-100 shadow-xl">
                ...
                <p className='text-justify p-4'>
                    ...
                    'Your Tools'is a leader in handy tools for different sectors. Our product line encompasses innovative, high-quality electric, hydraulic and pneumatic tools, which can be divided into four basic categories: metal working tools; concrete and masonry tools; specialty tools; and safety tools.
